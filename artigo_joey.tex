...
O design desse projeto foi a síntese da experiência de Torvalds com o projeto Linux. Ele precisava manter um projeto largo e distribuído ao mesmo tempo que precisava de um ambiente de trabalho funcional. Pra isso adotou as seguintes escolhas de implementação:

\subsubsection{Forte suporte para desenvolvimento não linear}
...
\subsubsection{Compatibilidade com os protocolos existentes}
